        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ URL('admin/jingdong/'.$products->id) }}" method="POST" class="form-horizontal" role="form">
                        <input name="_method" type="hidden" value="PUT">
                        <input name="type" type="hidden" value="{{ $products->type }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="skuid" class="form-control" value="{{ $products->skuid }}">
                            </div>
                        </div>
                        @if ($products->type === 0)
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="current_price" class="form-control" value="{{ $products->current_price }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">目标价格：</label>
                            <div class="col-sm-10">
                                <input type="text" name="target_price" class="form-control" value="{{ $products->target_price }}">
                            </div>
                        </div>
                        @endif
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="rate" class="form-control" value="{{ $products->rate }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">提醒邮箱：</label>
                            <div class="col-sm-10">
                                <input type="text" name="email" class="form-control" value="{{ $products->email }}">
                            </div>
                        </div>
                        <div class="form-group">
